...
int32_t bsp_GetRunTime(void)
{
	...
	runtime = Timing_5ms;	/* 这个变量在Systick中断中被改写，因此需要关中断进行保护 */
...
int32_t bsp_CheckRunTime(int32_t _LastTime)
{
	...
	DISABLE_INT();  	/* 关中断 */
	now_time = Timing_5ms;	/* 这个变量在Systick中断中被改写，因此需要关中断进行保护 */
	ENABLE_INT();  		/* 开中断 */
...
{	
	TimingDelay_Decrement();				//获取节拍程序    5ms
