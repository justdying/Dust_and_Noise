...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//用户根据自己的需要设置
#define STM32_FLASH_SIZE 768 	 		//所选STM32的FLASH容量大小(单位为K)
...
//FLASH解锁键值
#define FLASH_SAVE_ADDR  0x08080000		//设置FLASH 保存地址(必须为偶数，且其值要大于本代码所占用FLASH的大小+0X08000000)

#define SYSTEM_CONFIG_TABLE_ADDR 	FLASH_SAVE_ADDR+sizeof(System_Config_Table1) //0X08080064  
	
	
#define BOOTLEADER_FLAG_ADDR   0x08080100//FLASH_SAVE_ADDR+sizeof(System_Config_Table1)   //0X8080064   跟BOOTLEADER程序里面设置的应该一致
